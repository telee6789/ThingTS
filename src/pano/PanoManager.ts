 ...
 * @LastEditors: kekeqy
 * @LastEditTime: 2018-12-11 13:08:52
 * @Description: 全景图管理器，提供全景图创建，操作，事件
 */
export class PanoManager {
     ...
     */
    public static changePano(panoID: string, h: number, v: number): void {
        throw new Error('未实现！');
    }
     ...
     */
    public static compute3DObjectProperties(panoPosition: number[], modelPosition: number[], modelAngles: number[]): any {
        throw new Error('未实现！');
    }
     ...
     * @param properties 
     */
    public static create3DObject(name: string, url: string, anim: string, properties: {
        /**
         * 模型所在位置：水平坐标
         */
        h: number,
     ...
     */
    public static createPlayer(panoData: Object, panelOptions: {
        /**
         * 是否全屏
         */
        fullscreen: boolean,
     ...
     * 销毁全景图播放器
     */
    public static destroyPlayer(): void {
        throw new Error('未实现！');
    }
     ...
     */
    public static getPanoJsonFromBuilder(root: Campus, callback: (panoData: any) => void): void {
        throw new Error('未实现！');
    }
     ...
     * @param root 需要获取的根节点
     */
    public static getPanoPoints(root: any): any[] {
        throw new Error('未实现！');
    }
     ...
     * @param root 需要查询的根节点
     */
    public static hasPanoFromBuilder(root: any): boolean {
        throw new Error('未实现！');
    }
     ...
     * @param properties 
     */
    public static set3DObjectProperties(name: string, properties: {
        /**
         * 模型所在位置：水平坐标
         */
        h: number,
     ...
     */
    public static startTour(panoID: string): void {
        throw new Error('未实现！');
    }
